var J = Shape.extend({
    ...
    occupiedSquares: function() {
        if (this.rotatedPosition === 0)
            ...
            return [this.block.copy(), this.block.top(), this.block.bottom(), new Block(this.block.x - 1, this.block.y + 1, this.color)]; // j shape
    ...
    bottomSquares: function() {
        if (this.rotatedPosition === 0)
            ...
            return [this.block.bottom(), new Block(this.block.x - 1, this.block.y + 1, this.color)]; // j shape
        else if(this.rotatedPosition === 2)
            return [this.block.copy(), this.block.right(), this.block.left()];
        else if(this.rotatedPosition === 3)
